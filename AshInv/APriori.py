...
if __name__ == "__main__":
    ...
    parser.add("--min_time", type=datetime.datetime.fromisoformat, default=datetime.datetime(1900,1,1, tzinfo=datetime.timezone.utc), help="A priori values before this time is ignored")
    parser.add("--max_time", type=datetime.datetime.fromisoformat, default=datetime.datetime(2100,1,1, tzinfo=datetime.timezone.utc), help="A priori values after this time is ignored")
