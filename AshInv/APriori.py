...
if __name__ == "__main__":
    ...
    parser.add("--min_time", type=datetime.datetime.fromisoformat, default=datetime.datetime.min, help="All times before this are ignored")
    parser.add("--max_time", type=datetime.datetime.fromisoformat, default=datetime.datetime.max, help="All times after this are ignored")
